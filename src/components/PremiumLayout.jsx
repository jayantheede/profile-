  ...
  const navItems = [
    { label: 'Home', path: '/' },
    {
      ...
      items: [
        ...
        { label: 'Administrative Reports', path: '/activities/reports' }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Conferences & Seminars', path: '/research/conferences' },
        { label: 'Invited Talks', path: '/research/talks' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <a href={`tel:${data.personal.phone}`} className="flex items-center gap-2 text-sm text-blue-600 font-bold hover:underline">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                {data.personal.socialLinks?.linkedin ? (
                  <a href={data.personal.socialLinks.linkedin} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors cursor-pointer">
